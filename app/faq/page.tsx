...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://castleheightscannabis.ca/faq",
  },
};
...
const FAQ_CATEGORIES = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Do you have a live menu?", a: "Yes! Our online menu at castleheightscannabis.ca updates in real time with current stock, prices, THC levels, and availability. You can check what's in stock before you visit." },
