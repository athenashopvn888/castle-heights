...
export const metadata: Metadata = {
  ...
  description:
    "Apply online for budtender or manager opportunities at Castle Heights Cannabis in Ottawa. Submit availability, experience, motivation, determination, and customer-service answers.",
  alternates: {
...
const applicantFaqs = [
  ...
  },
  {
    ...
    a: "Tell us your real availability, earliest start date, retail background, what motivates you, and why you want to work with Castle Heights.",
  },
  {
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <div className={styles.heroCopy}>
            <span className={styles.eyebrow}>Castle Heights Careers</span>
            <h1>Budtenders / Managers Wanted</h1>
            <p>
              Castle Heights Cannabis is collecting applications from sharp, friendly budtender and manager candidates who can help customers shop with confidence and keep the store running smooth.
            </p>
          ...
          <div className={styles.heroPanel} aria-label="Hiring role snapshot">
            ...
            <ul>
              ...
              <li>Evening or late-shift availability is a plus at Castle Heights</li>
            </ul>
          </div>
        </div>
      </section>
