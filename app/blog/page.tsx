...
/* ── Google Reviews ── */
const REVIEWS = [
  { name: "Mike R.", rating: 5, text: "Best dispensary in the Vanier area area. Staff is super knowledgeable and the exotic strains are legit fire.", date: "2 weeks ago" },
  { name: "Sarah L.", rating: 5, text: "Love that they're open daily with late hours. The selection is insane — over 200 strains. My go-to spot.", date: "1 month ago" },
      ...
      <section className={styles.hero}>
        <div className={styles.heroInner}>
          <h1 className={styles.heroH1}>
            📝 Castle Heights <span className={styles.heroAccent}>Blog</span>
          </h1>
