...
Open the store page, browse the available menu/category sections, and use the contact or directions options when you are ready to plan your visit.`,
  ...
  },
  {
    ...
    title: "Castle Heights Cannabis Price and Flower Tier Guide",
    seoTitle: "Castle Heights Cannabis Price Tier Guide",
    seo_title: "Castle Heights Cannabis Price Tier Guide",
    metaDescription: "Castle Heights Cannabis guide to flower tiers, weight choices, unit value, and store visit planning in Ottawa.",
    meta_description: "Castle Heights Cannabis guide to flower tiers, weight choices, unit value, and store visit planning in Ottawa.",
    h1: "Castle Heights Cannabis Price and Flower Tier Guide",
    excerpt: "A simple guide to Castle Heights Cannabis flower tiers, weights, and unit value.",
    author: "The Castle Heights Cannabis Team",
    date: "2026-07-09",
    category: "Price Guide",
    readTime: "4 min",
    content: `## Castle Heights Cannabis Price and Flower Tier Guide

Castle Heights Cannabis makes flower shopping easier by organizing the menu into clear tiers. Start with the tier that matches the kind of flower you want, then choose the weight that fits your budget and visit.
...
For the smoothest visit, open the Castle Heights Cannabis menu before heading out. The live menu is the best place to compare current flower tiers, weights, and store-specific options. The store page is also useful for directions, contact details, and visit planning.
...
- Open the Castle Heights Cannabis store page for directions, contact details, and visit planning.
