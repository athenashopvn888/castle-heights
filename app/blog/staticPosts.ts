...
export const STATIC_POSTS: StaticBlogPost[] = [
  {
    slug: "castle-heights-ottawa-store-info-guide",
    title: "Castle Heights Cannabis Store Information for Ottawa Adults 19+",
    seoTitle: "Castle Heights Cannabis Guide | Ottawa Adult 19+",
    seo_title: "Castle Heights Cannabis Guide | Ottawa Adult 19+",
    metaDescription: "Adult 19+ guide to Castle Heights Cannabis around Ottawa / Castle Heights, with local store-page checks, menu-category context, and safe visit planning.",
    ...
    readTime: "4 min",
    content: `## Castle Heights Cannabis Local Store Guide for Adults 19+

Castle Heights Cannabis serves adults 19+ looking for store information around Ottawa / Castle Heights. Use this guide to get oriented, compare the store page with menu categories, and choose the most useful next step before visiting.
...
Castle Heights Cannabis is tied to Castle Heights and Overbrook context in Ottawa. Useful local content should make the page easier for shoppers to understand by connecting the store to nearby streets, neighbourhood language, and visit-planning details already supported by the site.
...
Start with the official Castle Heights Cannabis store page, then use the menu/category links to browse what the site makes easy to compare. Shoppers can confirm the right storefront, directions, contact options, and local visit details in one place.
...
### Is this guide for Castle Heights Cannabis only?

Yes. This guide is written for Castle Heights Cannabis and the local Ottawa context connected to this website.
...
Open the store page, browse the available menu/category sections, and use the contact or directions options when you are ready to plan your visit.`,
    faq: "",
    internal_links_used: "[Castle Heights Cannabis Ottawa store page](/weed-dispensary-ottawa)\\n[Castle Heights Cannabis homepage](/)\\n[More Castle Heights Cannabis guides](/blog)",
    relatedLinks: [
      {
            "title": "Castle Heights Cannabis Ottawa store page",
            "url": "https://castleheightscannabis.ca/weed-dispensary-ottawa",
            "description": "Primary store-specific destination for current store details after reading the guide."
      },
      {
            "title": "Castle Heights Cannabis homepage",
            "url": "https://castleheightscannabis.ca/",
            "description": "Store-scoped general navigation for adults 19+."
      },
      {
            "title": "More Castle Heights Cannabis guides",
            "url": "https://castleheightscannabis.ca/blog",
            "description": "Store-scoped blog index for future approved posts."
      }
],
  },
  {
    slug: "castle-heights-cannabis-price-flower-tier-guide",
    title: "Castle Heights Cannabis Price And Flower Tier Guide for Adults 19+",
    seoTitle: "Castle Heights Cannabis Price Tier Guide | Adult 19+",
    seo_title: "Castle Heights Cannabis Price Tier Guide | Adult 19+",
    metaDescription: "Adult 19+ guide to Castle Heights Cannabis flower tiers, weight choices, unit value, and store visit planning in Ottawa.",
    meta_description: "Adult 19+ guide to Castle Heights Cannabis flower tiers, weight choices, unit value, and store visit planning in Ottawa.",
    h1: "Castle Heights Cannabis Price And Flower Tier Guide for Adults 19+",
    excerpt: "A simple adult 19+ guide to Castle Heights Cannabis flower tiers, weights, and unit value.",
    author: "The Castle Heights Cannabis Team",
    date: "2026-07-09",
    category: "Price Guide",
    readTime: "4 min",
    content: `## Castle Heights Cannabis Price And Flower Tier Guide for Adults 19+

Castle Heights Cannabis keeps flower browsing simple for adults 19+ by organizing options into clear price and quality tiers. Instead of guessing where to start, shoppers can pick the grade they want first, then choose the weight that fits the visit and budget.

This guide explains how the tier ladder works, how unit value improves as the weight goes up, and how to use the live menu and store page before visiting on Center St in Ottawa.
...
For the smoothest visit, open the Castle Heights Cannabis menu before heading out. The live menu is the best place to compare current categories, weights, and store-specific options. The store page is also useful for directions, contact details, and quick visit planning.
...
- Browse the Castle Heights Cannabis store page for directions, contact details, and visit planning.
...
This guide is for adults 19+ who want a simple way to understand Castle Heights Cannabis flower tiers before visiting.`,
    faq: "",
    internal_links_used: "[Castle Heights Cannabis store page](/weed-dispensary-ottawa)\\n[Castle Heights Cannabis homepage](/)\\n[More Castle Heights Cannabis guides](/blog)",
    relatedLinks: [
      {
        title: "Castle Heights Cannabis store page",
        url: "https://castleheightscannabis.ca/weed-dispensary-ottawa",
