...
export default function HiringCallout() {
  return (
    <section
      aria-label="Castle Heights Cannabis hiring"
      style={{
    ...
    >
      ...
      >
        <div>
          ...
          >
            Castle Heights needs reliable people with good energy, determination, and a customer-first attitude. Online applications only. Please do not call the store about hiring.
          </p>
        </div>
        <Link
